...
class _TranslationScreenUsingDeepSeekState
  ...
  // Cache for storing recent translations (in-memory only)
  ...
  Future<void> _translateText() async {
    ...
    // Check if translation is cached in memory
    if (_translationCache.containsKey(textToTranslate)) {
      setState(() {
        _translatedText = _translationCache[textToTranslate]!;
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        _translationCache[textToTranslate] = translatedText;
      } else {
        setState(() {
          _translatedText =
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            //     SizedBox(width: 8),
            //     Expanded(
            //       child: Text('In-memory caching of recent translations'),
            //     ),
            //   ],
            // ),
          ],
